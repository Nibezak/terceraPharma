        ...
        <div class="-mx-4 flex flex-wrap">
            <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
                <div class="mb-10 w-full">
                    <a href="javascript:void(0)" class="mb-6 inline-block max-w-[160px]">
                        <img src="{{ asset('assets/images/logo/logo.png') }}" alt="logo" class="max-w-full" />
                    </a>
                    <p class="mb-8 max-w-[270px] text-base text-gray-7">
                        We Deliver Health care and medicine to your doorstep.
                    </p>
                            ...
                            @if ($socialLinks->instagram != null)
                                <a href="{{ $socialLinks->instagram }}" target="_blank"
                                    ...
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        ...
                                        <path
                                            d="M14.7554 1.8335H7.24463C4.25807 1.8335 1.83334 4.25823 1.83334 7.24479V14.6964C1.83334 17.7421 4.25807 20.1668 7.24463 20.1668H14.6962C17.7419 20.1668 20.1667 17.7421 20.1667 14.7555V7.24479C20.1667 4.25823 17.7419 1.8335 14.7554 1.8335ZM11.0296 15.4948C8.51614 15.4948 6.53496 13.4545 6.53496 11.0002C6.53496 8.54586 8.54571 6.50554 11.0296 6.50554C13.5136 6.50554 15.5243 8.54586 15.5243 11.0002C15.5243 13.4545 13.5431 15.4948 11.0296 15.4948ZM15.634 6.1243C15.1151 6.1243 14.6859 5.69516 14.6859 5.17624C14.6859 4.65733 15.1151 4.22819 15.634 4.22819C16.1529 4.22819 16.582 4.65733 16.582 5.17624C16.582 5.69516 16.1529 6.1243 15.634 6.1243Z" />
                                    </svg>
                                </a>
                            @endif
            ...
            <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
                <div class="mb-10 w-full">
                    ...
                    <ul>
                        <li>
                            <a href="/on-sale" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
                                Sales
                            </a>
                        </li>
                        <li>
                            <a href="/categories" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
                                categories
                            </a>
                        </li>

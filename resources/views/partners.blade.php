...
@php
    ...
    $partners = DB::table('partners')->select('id', 'name', 'image')->get();
@endphp
@section('content')
    <!-- Hero section -->
                ...
                <div class="w-full px-4">
                    <div class="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
                        <h1
                            ...
                            Tercera Works with Industry leading partners
                        </h1>
                        <p class="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                            "Health within Reach, Care You Can Afford. we work with partners to insure you have a smooth
                            sailing with your services."
                        </p>
    ...
    <!-- Service section -->
    <section class="service-section py-16 bg-white" style="margin-top: 5rem;">
        <div class="container mx-auto">

            <section class="pb-10  dark:bg-dark">
                ...
                <div class="container px-4">
                    <div class="-mx-4 flex flex-wrap items-center justify-center gap-8 xl:gap-11">
                        @foreach ($partners as $partner)
                            <a href="#">
                                <!-- Adjust the href to your partner's website URL if available -->
                                <img src="{{ asset('storage/' . $partner->image) }}" alt="{{ $partner->name }}"
                                    class="dark:hidden" width="50%" />
                                <img src="{{ asset('storage/' . $partner->image) }}" alt="{{ $partner->name }}"
                                    class="hidden dark:block" width="50%" />
                            </a>
                        @endforeach
                    </div>
                </div>

...
@section('content')
            ...
            <div class="-mx-4 flex flex-wrap items-center">
                <div class="w-full px-4">
                    <div class="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
                        <h1
                            ...
                            Tercera Provides Medicine at affordable prices
                        </h1>
                        <p class="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                            "Health within Reach, Care You Can Afford. Tercera Provides Medicine at Affordable Prices,
                            Putting Wellness in Every Hand."
                        </p>
                ...
                <div class="w-full px-4">
                    <div class="wow fadeInUp relative z-10 mx-auto max-w-[845px]" data-wow-delay=".25s">
                        ...
                        <div class="absolute -left-9 bottom-0 z-[10]">
            ...
            <div class="w-full px-4">
                <div class="mx-auto mb-12 max-w-[485px] text-center lg:mb-[70px]">
                    ...
                    <h2
                        ...
                        Top Tier Health Package
                    </h2>
                    <p class="text-base text-body-color dark:text-dark-6">
                        Here are some of the products in our catalog ,
                    </p>
                </div>
            </div>
        </div>
                ...
                @foreach ($products as $p)
                    <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 px-4 mb-8">
                        <div class="shadow-md rounded-md overflow-hidden">
                            <div class="relative">
                                <a href="{{ route('single-product', $p->slug) }}" class="block">
                                    @if ($p->photos->count() > 0)
                                        <img src="/storage/{{ $p->photos->first()->images }}" alt="{{ $p->name }}"
                                            class="w-full h-48 object-cover transition-transform duration-300 group-hover:scale-110" />
                                    @else
                                        <img src="{{ asset('frontend/img/no-image.png') }}" alt="No image available"
                                            class="w-full h-48 object-cover transition-transform duration-300 group-hover:scale-110" />
                                    @endif
                                </a>
                                <div class="absolute top-4 right-4 flex space-x-2">
                                    <form action="{{ route('cart.store') }}" method="post" class="mx-1">
                                        @csrf
                                    ...
                                    <form action="{{ route('wishlist.store') }}" method="post" class="mx-1">
                                        @csrf
                                        <input type="hidden" name="id" value="{{ $p->id }}">
                                        <input type="hidden" name="name" value="{{ $p->name }}">
                                        <input type="hidden" name="price" value="{{ $p->price }}">
                                        <input type="hidden" name="quantity" value="1">
                                        <button type="submit"
                                            class="bg-secondary text-white p-2 rounded-full hover:bg-secondary-dark">
                            ...
                            <div class="p-4 text-center">
                                <a href="{{ route('single-product', $p->slug) }}">
                                    <h3 class="text-lg font-semibold text-dark dark:text-white hover:text-primary">
                                        {{ $p->name }}
                                    </h3>
                                </a>
                                ...
                                <span class="block mt-2 text-lg font-bold text-primary">
                                    rwf{{ $p->price }}
                                </span>
                            </div>
                        </div>
            ...
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4">
                    <div class="mx-auto mb-12 max-w-[485px] text-center lg:mb-[70px]">
                        ...
                        <h2
                            class="mb-3 text-3xl font-bold text-dark dark:text-white sm:text-4xl md:text-[40px] md:leading-[1.2]">
                            Main Features of Tercera Pharma
                        </h2>
                        <p class="text-base text-body-color dark:text-dark-6">
                            At Tercera Pharma, we provide a wide range of healthcare products
                            with the convenience of doorstep delivery. Explore our features
                            to see how we prioritize your health.
                        </p>
                    </div>
                </div>
            </div>
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp group mb-12" data-wow-delay=".1s">
                        ...
                        <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                            Tercera Pharma offers high-quality health products at competitive prices, ensuring that
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp group mb-12" data-wow-delay=".15s">
                        ...
                        <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                            Get your prescriptions filled from the comfort of your home. Tercera Pharma collaborates with
                            licensed pharmacists for secure and accurate service.
                        </p>
                    </div>
                </div>
                <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp group mb-12" data-wow-delay=".2s">
                        <div
                            ...
                            <svg width="30" height="37" viewBox="0 0 30 37" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M25.548 0.5H4.54803C2.26754 0.5 0.421875 2.34567 0.421875 4.62615V32.3738C0.421875 34.6543 2.26754 36.5 4.54803 36.5H25.548C27.8285 36.5 29.6742 34.6543 29.6742 32.3738V4.62615C29.6742 2.34567 27.8285 0.5 25.548 0.5ZM4.54803 2.5H25.548C26.7168 2.5 27.6742 3.45744 27.6742 4.62615V5.63098H2.42188V4.62615C2.42188 3.45744 3.37932 2.5 4.54803 2.5ZM25.548 34.5H4.54803C3.37932 34.5 2.42188 33.5426 2.42188 32.3738V7.63098H27.6742V32.3738C27.6742 33.5426 26.7168 34.5 25.548 34.5ZM15.548 29.5C19.1767 29.5 22.048 26.6287 22.048 23C22.048 19.3713 19.1767 16.5 15.548 16.5C11.9193 16.5 9.04803 19.3713 9.04803 23C9.04803 26.6287 11.9193 29.5 15.548 29.5ZM15.548 18.5C17.9059 18.5 19.948 20.5421 19.948 23C19.948 25.4579 17.9059 27.5 15.548 27.5C13.1901 27.5 11.148 25.4579 11.148 23C11.148 20.5421 13.1901 18.5 15.548 18.5Z"
                                    fill="white" />
                            </svg>
                        </div>
                        <h4 class="mb-3 text-xl font-bold text-dark dark:text-white">
                        ...
                        <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                            Pay securely through multiple payment gateways, ensuring your personal and financial information
                    ...
                    <div class="wow fadeInUp group mb-12" data-wow-delay=".25s">
                        <div
                            ...
                            <svg width="33" height="34" viewBox="0 0 33 34" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M29.7227 4.11017C26.9727 1.36017 22.6027 1.36017 19.8527 4.11017L16.6027 7.36017L13.3527 4.11017C10.6027 1.36017 6.23266 1.36017 3.48266 4.11017C0.679157 6.86017 0.679157 11.2877 3.48266 14.0377L6.73266 17.2877L16.6027 27.1577L26.4727 17.2877L29.7227 14.0377C32.5227 11.2877 32.5227 6.86017 29.7227 4.11017ZM28.3127 12.6277L16.6027 24.3377L4.89266 12.6277C3.35266 11.0877 3.35266 8.53517 4.89266 6.99517C6.43266 5.45517 8.97916 5.45517 10.5227 6.99517L13.3527 9.82517L16.6027 13.0752L19.8527 9.82517L22.6827 6.99517C24.2227 5.45517 26.7692 5.45517 28.3127 6.99517C29.8527 8.53517 29.8527 11.0877 28.3127 12.6277Z"
                                    fill="white" />
                            </svg>
                        </div>
                        <h4 class="mb-3 text-xl font-bold text-dark dark:text-white">
                        ...
                        <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                            Our dedicated team ensures that your medicines reach your doorstep quickly and in perfect
                            condition, so you never miss a dose.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="w-full px-4 lg:w-1/2">
                        <div class="mb-12 max-w-[540px] lg:mb-0">
                            <h2
                                ...
                                Excellence in Pharmaceutical Care, Delivered to Your Doorstep.
                            </h2>
                            <p class="mb-10 text-base leading-relaxed text-body-color dark:text-dark-6">
                                At Tercera Pharma, we are dedicated to providing top-quality medications and healthcare
                                products right to your door. Our mission is to ensure that you have access to the medicines
                                you need, with the convenience and reliability you deserve.
                                <br /><br />
                                With years of experience and a commitment to excellence, we have become a trusted name in
                                online pharmaceutical care. Our team of experts is here to guide you every step of the way,
                                ensuring that your health and wellness are our top priority.
                            </p>
                    ...
                    <div class="w-full px-4">
                        <div class="mx-auto max-w-[570px] text-center">
                            ...
                            <p class="mx-auto mb-6 max-w-[515px] text-base leading-[1.5] text-white">
                                There are many variations of Health Products Including medicine, skin care and more .
                            </p>
                            <a href="javascript:void(0)"
                                class="inline-block rounded-md border border-transparent bg-primary px-7 py-3 shadow-md text-base font-medium text-white transition hover:bg-[#0BB489]">
                                Go to the store
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="rounded-xl bg-white px-4 py-[30px] shadow-testimonial dark:bg-dark sm:px-[30px]">
                                ...
                                <p class="mb-6 text-base text-body-color dark:text-dark-6">
                                    “The delivery was so fast it almost felt like they were around the corner. I am very
                                    impressed’’
                                </p>
                                ...
                                <a href="#" class="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-body-secondary">Rwanda | Kigali</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="rounded-xl bg-white px-4 py-[30px] shadow-testimonial dark:bg-dark sm:px-[30px]">
                                ...
                                <p class="mb-6 text-base text-body-color dark:text-dark-6">
                                    “I was expecting them not to work in late hours like 1 am
                                    But they were already on standby ’’
                                </p>
                        ...
                        <div class="swiper-slide">
                            <div class="rounded-xl bg-white px-4 py-[30px] shadow-testimonial dark:bg-dark sm:px-[30px]">
                                ...
                                <p class="mb-6 text-base text-body-color dark:text-dark-6">
                                    ...
                                    It's distraction free. you get your products right away.’’
                                </p>
                        ...
                        <div class="swiper-slide">
                            <div class="rounded-xl bg-white px-4 py-[30px] shadow-testimonial dark:bg-dark sm:px-[30px]">
                                ...
                                <p class="mb-6 text-base text-body-color dark:text-dark-6">
                                    “Amazing services , I don't see myself using any other services
                                    .’’
                                </p>
    ...
    <section class="pb-10 dark:bg-dark py-2 my-5">
        ...
        <div class="container px-4">
            <div class="flex flex-wrap gap-4 justify-center">
                @foreach ($partners as $partner)
                    <div class="flex-shrink-0 w-1/5 max-w-[135px]">
                        <a href="#">
                            <img src="{{ asset('storage/' . $partner->image) }}" alt="{{ $partner->name }}"
                                class="dark:hidden" style="max-width: 135px; max-height: 135px; object-fit: contain;" />
                            <!-- Add a second image for dark mode if needed -->
                            <!-- <img src="{{ asset('storage/' . $partner->image) }}" alt="{{ $partner->name }}" class="hidden dark:block w-full h-auto object-contain" /> -->
                        </a>
                    </div>
                @endforeach
            </div>
                ...
                <div class="w-full px-4">
                    <div class="mx-auto mb-[60px] max-w-[520px] text-center">
                        ...
                        <p class="mx-auto max-w-[485px] text-base text-body-color dark:text-dark-6">
                            There are many variations of passages of tercera available
                            but the majority have suffered alteration in some form.
                        </p>
                    </div>
                </div>
                ...
                <div class="w-full px-4 lg:w-1/2">
                    <div class="mb-12 flex lg:mb-[70px]">
                        ...
                        <div class="w-full">
                            ...
                            <p class="text-base text-body-color dark:text-dark-6">
                                Tercera is a Pharmaceutical Company , we handle medicine delivery for you so you do not have
                                to move an inch.
                    ...
                    <div class="mb-12 flex lg:mb-[70px]">
                        ...
                        <div class="w-full">
                            <h3
                                class="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
                                Is Tercera like Uber for medicine ?
                            </h3>
                            <p class="text-base text-body-color dark:text-dark-6">
                                Yes , when you need drugs , soap or any health products you can simply order from Tercera.rw
                            </p>
                        </div>
                    </div>
                </div>
                <div class="w-full px-4 lg:w-1/2">
                    <div class="mb-12 flex lg:mb-[70px]">
                        ...
                        <div class="w-full">
                            <h3
                                class="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
                                Is on delivery payment accepted ?
                            </h3>
                            <p class="text-base text-body-color dark:text-dark-6">
                                Yes you can choose to pay via MTN Mobile Money or cash on the delivery, We want our
                                customers to be satisfied with our services
                            </p>
                        </div>
                    </div>
                    <div class="mb-12 flex lg:mb-[70px]">
                        ...
                        <div class="w-full">
                            ...
                            <p class="text-base text-body-color dark:text-dark-6">
                                Delivery fee depends on where you are but on average it is 1000 rwf
                            </p>
                        </div>
                    </div>
                </div>

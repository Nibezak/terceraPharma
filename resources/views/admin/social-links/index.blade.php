...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between btn-sm">
            ...
            <a href="{{ isset($socialLinks) ? route('social-links.edit', $socialLinks->id) : route('social-links.create') }}"
                class="btn btn-dark">{{ isset($socialLinks) ? 'Edit Social Links' : 'Add Social Links' }}</a>
        </div>
        <div class="card-body">
            @if ($socialLinks != null)
